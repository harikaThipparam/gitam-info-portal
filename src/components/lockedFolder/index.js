    ...
    <div className="hall-main-container">
      ...
      <div className="unlock-container">
        <svg
          ...
          height="50"
          fill="red"
          className="bi bi-database-lock mb-2"
          viewBox="0 0 16 16"
        >
        ...
        <p>This service is Locked now. it will be unlock after few days </p>
        <p>
          Please upload your hall Ticket number to access this service{" "}
          <a
